---
title: "TiTiler with STAC"
date: 2026-01-24
categories:
  - Web GIS
  - Raster Data Visualization
  - STAC
description: "Learn how to use TiTiler's STAC endpoints to explore and visualize satellite imagery. From basic info to advanced band math and colormaps."
image: stac_render.png
draft: false
---

In our [previous post](../titiler-intro/index.md), we set up TiTiler for serving Cloud-Optimized GeoTIFFs. Now let's explore how TiTiler works with STAC (SpatioTemporal Asset Catalog) - a standardized way to describe and organize geospatial data.

> **Prerequisites**: For Python environment and TiTiler setup, check out the [Getting Started with TiTiler](../titiler-intro/index.md) post.
...
![stac_asset_preview.png](stac_asset_preview.png)
